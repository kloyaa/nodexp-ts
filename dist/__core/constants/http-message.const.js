...
exports.httpMessage = {
    ...
    "10200": {
        "code": "10200",
        "message": "Oops! Invalid email address format. Please enter a valid email address and try again."
    },
    "10201": {
        "code": "10201",
        "message": "Oops! Invalid mobile number format. Please enter a valid mobile number and try again."
    },
    "10202": {
        "code": "10202",
        "message": "We're sorry, but your account has been deactivated for violating our platform's rules and standards. Please review our policies and contact us if you have any questions or concerns."
    },
    "10203": {
        "code": "10203",
        "message": "We're sorry for the inconvenience, but our server is currently undergoing maintenance. We'll be back up and running as soon as possible. Thank you for your patience!",
    },
    "10204": {
        "code": "10204",
    ...
    "10404": {
        "code": "10404",
        "message": "Oops! Invalid wallet address destination. Please double-check and try again.",
    },
    "10405": {
        "code": "10405",
        "message": "Transaction is processing. Please wait a moment and refresh the page for updates.",
    },
    "10406": {
        "code": "10406",
        "message": "Oops! We couldn't find your wallet. Please double-check the address or create a new wallet and link it.",
    },
    "10407": {
        "code": "10407",
        "message": "We apologize, but your transaction has failed due to a mismatch in seedphrases. The seedphrase associated with the address you provided doesn't match the one currently stored in your wallet. To resolve this issue, please update your wallet's seedphrase to match the one used for your account. You can make this update by going to your wallet settings. If you require any assistance with this process, please don't hesitate to contact our support team.",
    }
};
//# sourceMappingURL=http-message.const.js.map